...
<form method="post" action="edit_admin.php" id="setting-form">
    <h1>Pramétre</h1>
    <div class="container" id="content">
        <div class="user-setting">
            ...
            <div class="password">
                ...
                <div class="input nv_pass" style="display: none">
            ...
            <a href="#" id="" onclick="$('.nv_pass').show(); $(this).hide();">nouveau mot de passe</a>
