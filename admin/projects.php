...
<article>
    ...
    <div class="add-prj_pop" style="display: none">
        <div class="container-box animated rubberBand">
                <button class="exit">
                    <i class="material-icons">cancel</i>
                </button>
                <form method="post" action="projectsave.php" id="add_prj-form">
                <div class="project-info">
                    ...
                    <script>
                        ...
                        function isEmpty() {
                            var isEmpty = true;
                            $("#add_prj-form input").each(function () {
                                var element = $(this);
                                if (element.val() == "") {
                                    $(this).siblings('.err').css({
                                        'display': 'block'
