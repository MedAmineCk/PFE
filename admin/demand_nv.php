<?php
    ...
    $query = "SELECT * FROM Demande,User WHERE   Demande.user_id=User.user_id AND (Demande.etat='non' OR Demande.etat='avoir')"; 
...
<div class="demand-item" data-user="<?php echo $row['nom'];?>" data-email="<?php echo $row['email'];?>"
    data-desc="<?php echo $row['discription'];?> " data-demandid="<?php echo $row["demand_id"];?>" data-d_date="date">
    <div class="icon">
...
<div class="demand-pop_up">
    <div class="pop-container">
        ...
        <div class="btns">
            ...
            <button class="save">confirmer</button>
        </div>
    </div>
</div>
<script>
